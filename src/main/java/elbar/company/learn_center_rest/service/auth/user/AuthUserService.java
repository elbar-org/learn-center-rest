...
public interface AuthUserService extends GenericCUDService<AuthUserCreateDTO, AuthUserUpdateDTO, UUID>, GenericGLDService<AuthUserGetDTO, AuthUserDetailDTO, UUID>, UserDetailsService {
}
